...
export default function EditPostPage() {
  ...
  const { posts, updatePost, isAdmin } = useBlog();
    ...
    return (
      <div className="text-center py-20 animate-fade-in">
        ...
        <button
          ...
          className="mt-4 inline-flex items-center gap-1 text-xs font-bold text-zinc-900 dark:text-white underline cursor-pointer"
        >
          목록으로 돌아가기
        </button>
      </div>
